...
def omni(start_date, end_date, params=None, resolution='hour', show_url=False):
    ...
    **Low Resolution OMNI (LRO) Data Set**
    ...
    +--------------------+----------------+----------------------------------------+
    | Short Name         | OMNIWeb Index | Description                             |
    +====================+================+========================================+
    | BRN                | 3              | Bartels Rotation Number                |
    +--------------------+----------------+----------------------------------------+
    | IMF_ID             | 4              | IMF Spacecraft ID                      |
    ...
    | Alfven             | 37             | Alfven Mach Number                     |
    +--------------------+----------------+----------------------------------------+
    | Kp                 | 38             | Kp*10 Index (Geomagnetic Activity)     |
    +--------------------+----------------+----------------------------------------+
    | R_Sunspot          | 39             | R Sunspot Number                       |
    +--------------------+----------------+----------------------------------------+
    | Dst                | 40             | Dst Index, nT (Geomagnetic Storm Index)|
    +--------------------+----------------+----------------------------------------+
    | AE                 | 41             | AE Index, nT (Auroral Electrojet)      |
    +--------------------+----------------+----------------------------------------+
    | PFlux_1MeV         | 42             | Proton Flux > 1 MeV                    |
    +--------------------+----------------+----------------------------------------+
    | PFlux_2MeV         | 43             | Proton Flux > 2 MeV                    |
    ...
    | AP                 | 49             | AP index, nT                           |
    +--------------------+----------------+----------------------------------------+
    | F10.7              | 50             | Solar Flux Index (F10.7)               |
    +--------------------+----------------+----------------------------------------+
    | PC                 | 51             | Polar Cap Index                        |
    +--------------------+----------------+----------------------------------------+
    | AL                 | 52             | AL Index, nT                           |
    +--------------------+----------------+----------------------------------------+
    | AU                 | 53             | AU Index, nT                           |
    ...
    **High Resolution OMNI (HRO) Data Set**
    ...
    | IMF_Mag                  | 13             | IMF Magnitude Avg (Scalar), nT                    |
    +--------------------------+----------------+---------------------------------------------------+
    | Bx_GSE                   | 14             | Bx component, GSE/GSM, nT                         |
    +--------------------------+----------------+---------------------------------------------------+
    | By_GSE                   | 15             | By component, GSE, nT                             |
    +--------------------------+----------------+---------------------------------------------------+
    | Bz_GSE                   | 16             | Bz component, GSE, nT                             |
    +--------------------------+----------------+---------------------------------------------------+
    | By_GSM                   | 17             | By component, GSM, nT                             |
    +--------------------------+----------------+---------------------------------------------------+
    | Bz_GSM                   | 18             | Bz component, GSM, nT                             |
    +--------------------------+----------------+---------------------------------------------------+
    | Sigma_IMF_Mag            | 19             | Sigma in IMF Magnitude Avg.                       |
    +--------------------------+----------------+---------------------------------------------------+
    | Sigma_IMF_Vec            | 20             | Sigma in IMF Vector Avg                           |
    ...
    | PC                       | 44             | Polar Cap (PC) index from Thule                   |
    +--------------------------+----------------+---------------------------------------------------+
    | PFlux_10MeV              | 46             | Proton Flux > 10 MeV, 1/(cm²-sec-ster)            |
    +--------------------------+----------------+---------------------------------------------------+
    | PFlux_30MeV              | 47             | Proton Flux > 30 MeV, 1/(cm²-sec-ster)            |
    +--------------------------+----------------+---------------------------------------------------+
    | PFlux_60MeV              | 48             | Proton Flux > 60 MeV, 1/(cm²-sec-ster)            |
    +--------------------------+----------------+---------------------------------------------------+
