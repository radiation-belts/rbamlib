...
def VS1975_Phi_corr(r, theta, Omega, B0, R0):
    r"""
    Compute the corotational electric potential for the Volland‐Stern (Volland (1973) [#]_ and Stern (1975) [#]_) model.
...
def VS1975_E_corr(r, theta, Omega, B0, R0):
    r"""
    Compute the corotational electric field for the Volland‐Stern (Volland (1973) [#]_ and Stern (1975) [#]_) model.
...
def VS1975_Phi_conv(r, phi, theta, gamma, C, r0):
    r"""
    Compute the convective electric potential for the Volland‐Stern (Volland (1973) [#]_ and Stern (1975) [#]_) model.
...
def VS1975_E_conv(r, phi, theta, gamma, C, r0):
    r"""
    Compute the convective electric field for the Volland‐Stern (Volland (1973) [#]_ and Stern (1975) [#]_) model.
...
def VS1975(r, phi=0, theta=np.pi/2, planet='Earth', gamma=None, C=None, r0=None, Omega=None, B0=None, R0=None):
    r"""Compute the total electric field for the Volland‐Stern (Volland (1973) [#]_ and Stern (1975) [#]_) model.
